...
import { insertData} from "../services/reporteDescarga/Insert.services";
...
import ReporteDescarga from "../interface/reporteDescarga";


export const createReporteDescarga = async (req: Request, res: Response) => {
  const tableName = "reportedescarga"; // Reemplaza con el nombre de tu tabla
  const data: ReporteDescarga = req.body;
...
export const getProblemaDescarga = async (req: Request, res: Response) => {
...
export const getReporteDescarga = async (req: Request, res: Response) => {
  const tableName = "reportedescarga"; // Reemplaza con el nombre de tu tabla
...
// export const getReportedescarga = async (req: Request, res: Response) => {
//   const tableName = "reporte_descarga"; // Reemplaza con el nombre de tu tabla
...
// tu controlador
export const updateReporteDescarga = async (req: Request, res: Response) => {
  const tableName = "reportedescarga";
  const newData: ReporteDescarga = req.body;
...
export const getOneReporteDescarga = async (req: Request, res: Response) => {
  const { id } = req.params;
  const tableName = "reportedescarga"; // Reemplaza con el nombre de tu tabla
