...
import { insertData} from "../services/proveedor/Insert.services";
// import Garden from "../interface/garden";
import { getOneData } from "../genericQueries/getOne.services";
import { deleteGardenData } from "../services/delete.services";
import { getData } from "../genericQueries/getBuilder";
import { updateData } from "../services/proveedor/update.services";
...
export const getProveedor = async (req: Request, res: Response) => {
  ...
  try {
    ...
    console.error("Error getting proveedor data:", error);
...
export const updateProveedor = async (req: Request, res: Response) => {
  ...
  const newData: Proveedor = req.body;
