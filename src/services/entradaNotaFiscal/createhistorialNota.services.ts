...
export async function createDataHistorial(tableName: string, data: Record<string, any>): Promise<any> {
  const {cod_empresa, id_proveedor, id_notafiscal, numeroNota, modelo, operacion,formaDePago, condicionPago, id_vehiculo, id_producto, cantidad_total, id_usuario} = data;
